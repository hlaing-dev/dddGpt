...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (currentData?.data) {
      ...
      let filteredData = currentData?.data?.filter(
        (newPost: any) =>
  ...
  //     setVideos({
  //       ...videos,
  //       ["follow"]: [], // Append to the current tab
  //     })
  //   );
  //   followRefetch();
  // }, [user1]);
                    ...
                    {followData?.data?.length > 0 && (
                      <>
                            ...
                            {showFollowers && (
                              <div
                                onTouchStart={() => {
                                  ...
                                  showFollowers && setShowFollowers(false);
                                }}
                                onClick={() =>
                                  showFollowers && setShowFollowers(false)
                                }
                                className="absolute inset-0 top-[160px] left-0 right-0 z-[999999] bg-transparent"
                              ></div>
                            )}
                          </>
                        )}
                        ...
                        <div
                          ...
                          className={`app__videos pb-[80px] transition-all duration-300 ease-in-out overflow-hidden transform ${
